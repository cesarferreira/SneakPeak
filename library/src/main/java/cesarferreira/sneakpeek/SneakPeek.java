...
public class SneakPeek {
    ...
    public static final long LONG_CLICK_DURATION = 200;
    protected static final long LONG_HOLD_DURATION = 850;
    protected static final long HOLD_AND_RELEASE_DURATION = 50;

    public static final int FLING_VELOCITY_THRESHOLD = 3000;
    public static final float FLING_VELOCITY_MAX = 1000;

    protected static final int ANIMATION_PEEK_DURATION = 275;
    public static final int ANIMATION_POP_DURATION = 250;
    ...
    public OnFlingToActionListener onFlingToActionListener;
    ...
    protected void init() {
        ...
        this.peekViewMargin = DimensionUtil.Companion.convertDpToPx(builder.activity.getApplicationContext(), PEEK_VIEW_MARGIN);
     ...
     */
    public void handleTouch(@NonNull View view, @NonNull MotionEvent event, int position) {
    ...
    private void checkLongHoldViews(final int position) {
        for (int i = 0; i < longHoldViews.size(); i++) {
            ...
            boolean viewInBounds = DimensionUtil.Companion.pointInViewBounds(longHoldView.getView(), downX, downY);
    ...
    private void checkHoldAndReleaseViews(final int position) {
        for (int i = 0; i < holdAndReleaseViews.size(); i++) {
            ...
            boolean viewInBounds = DimensionUtil.Companion.pointInViewBounds(holdAndReleaseView.getView(), downX, downY);
    ...
    private void blurBackground() {
        ...
        peekLayout.setBackground(new BitmapDrawable(builder.activity.getResources(), BlurBuilder.Companion.blur(contentView)));
    }
